...
/* Last-Modified: Thu, 28 Mar 2019 23:26:39 GMT */
const uint32_t imageLastModified = 1553815599U;

static const uint8_t imageFileData[11429U] = {
...
static const imageFileItem imageFileTable[9U+1U] = {
  { 0xCE01AC41U, &imageFileData[0U]     },    // "dir.cgi"
  { 0x9654BF31U, &imageFileData[300U]   },    // "format.cgi"
  { 0xDE703953U, &imageFileData[1205U]  },    // "home.png"
  { 0x1B16B2C5U, &imageFileData[2594U]  },    // "index.htm"
  { 0x90CE4E8AU, &imageFileData[4734U]  },    // "keil.gif"
  { 0x7049A0E1U, &imageFileData[5872U]  },    // "llblue.jpg"
  { 0xA35A02C8U, &imageFileData[8880U]  },    // "logo.gif"
  { 0x3BDBDB05U, &imageFileData[10667U] },    // "pabb.gif"
  { 0xC48DAE83U, &imageFileData[10788U] },    // "upload.cgi"
  { 0x00000000U, &imageFileData[11429U] }
};
